...
//                 {/* '{props.modalRecipe.name || ''}' */}
//                 <p>
//                   Delete from{' '}
//                   {props.list_type == constants.recipeList.BOOKMARK_LIST ? 'bookmarked recipes' : 'my recipes'}?
//                 </p>
//               </div>
...
//                 <button
//                   type='button'
//                   onClick={(e) => this.deleteRecipe(e, props.modalRecipe.id)}
...
//           {props.list_type == constants.recipeList.BOOKMARK_LIST ? 'Bookmarked Recipes' : 'My Recipes'}
//         </h3>
//         {props.list_type !== constants.recipeList.BOOKMARK_LIST ? (
//           <Link to='recipes/add'>
//             <button style={{float: 'right'}} type='button' className='btn btn-success'>
//               Create Recipe
//             </button>
...
//                 </Link>
//                 <span />
//                 {props.list_type !== constants.recipeList.BOOKMARK_LIST && !isUndefined(props.users) ? (
//                   <div style={{display: 'inline', fontSize: '14px'}}>
//                     by {props.users.find((x) => x.id == recipe.creator).username}
//                   </div>
//                 ) : null}
//                 <Link to={'recipe/' + recipe.id}>
//                   <div className='panel panel-default' style={{marginTop: '10px'}}>
...
//
//   return {
//     recipeInfo: state.recipeList[0].myrecipes,
//     recipes: state.recipeList[0].myrecipes,
