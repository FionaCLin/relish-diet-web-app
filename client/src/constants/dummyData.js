...
export const recipeInfo = [
  {
    ...
    ingredients: ['160 g of cherry tomatoes', '4 slices of wholemeal bread', '3 large eggs', '80 g of baby spinach'],
    comments: [
      {
        commentor: 2,
